...
<div class="page-content">
        ...
        <div class="row profile-body">
          ...
          <div class="col-md-8 col-xl-8 middle-wrapper">
			...
			<h6 class="card-title">Add Seksyen   </h6>

			<form method="POST" action="{{ route('store.seksyen') }}" class="forms-sample" enctype="multipart/form-data">
				@csrf
 

				<div class="mb-3">
 <label for="exampleInputEmail1" class="form-label">Seksyen Name   </label>
					 <input type="text" name="seksyen_name" class="form-control " > 
				</div>
 ...
 <label for="exampleInputEmail1" class="form-label">    </label>
  <img id="showImage" class="wd-80 rounded-circle" src="{{ url('upload/no_image.jpg') }}" alt="profile">
	 ...
	 <button type="submit" class="btn btn-primary me-2">Add Seksyen </button>
