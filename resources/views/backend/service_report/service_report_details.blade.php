...
@section('title1')
  Service Report Details | MyFixIt  
@endsection
...
<tr>
    ...
    <td>{{ $msgdetails->user->phone ?? $msgdetails->msg_phone ?? '-' }}</td>
</tr>

                       <tr>
                          <th>Service Name : </th>
                          <td>{{ $msgdetails['service']['service_name'] }}</td>
                      </tr>
                       <tr>
                          <th>Service Code : </th>
                          <td>{{ $msgdetails['service']['service_code'] }}</td>
                      </tr>

                       <tr>
                          <th>Technician Name : </th>
                          <td>{{ $msgdetails['technician']['name'] }}</td>
                      </tr>
                       <tr>
                          <th>Message  : </th>
