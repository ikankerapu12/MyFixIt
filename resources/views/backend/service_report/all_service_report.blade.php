...
<div class="page-content">
                      ...
                      <ul class="nav flex-column">
                        <li class="nav-item active">
                          <a class="nav-link d-flex align-items-center" href="{{ route('admin.service.report') }}">
                            <i data-feather="clipboard" class="icon-lg me-2"></i>
                            Service Report
                      ...
                      <div class="row align-items-center">
                        <div class="col-lg-6">
                          <div class="d-flex align-items-end mb-2 mb-md-0">
                            <i data-feather="clipboard" class="text-muted me-2"></i>
                            <h4 class="me-1">Service Report</h4>
      ...
      <div class="email-list-item">
        ...
        <a href="{{ route('service.report.details',$msg->id) }}" class="email-list-detail">
          <div class="content">
