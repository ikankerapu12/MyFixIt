        ...
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="text-muted mb-3">View customer reviews and ratings</p>
                        ...
                        <table id="dataTableExample" class="table table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('admin.show.review', $review->id) }}" class="btn btn-sm btn-primary" title="View">
                                            <i data-feather="eye"></i>
                                        </a>
                                        <a href="{{ route('admin.delete.review', $review->id) }}" class="btn btn-sm btn-danger" id="delete" title="Delete">
