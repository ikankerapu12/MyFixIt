...
@section('title2')
  Technician Change Password | MyFixIt  
@endsection
...
<img class="wd-100 rounded-circle" src="{{ (!empty($profileData->photo)) ? url('upload/technician_images/'.$profileData->photo) : url('upload/no_image.jpg') }}" alt="profile">
        ...
        <div class="col-md-8 col-xl-8 middle-wrapper">
            ...
            <h6 class="card-title">Technician Change Password  </h6>

            <form method="POST" action="{{ route('technician.update.password') }}" class="forms-sample" enctype="multipart/form-data">
                @csrf
