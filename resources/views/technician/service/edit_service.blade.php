...
@section('title2')
  Technician Edit Service | MyFixIt  
@endsection
<div class="page-content">
    ...
    <div class="card-body">
        <h6 class="card-title">Edit Service </h6>
            <form method="post" action="{{ route('technician.update.service') }}" id="myForm" enctype="multipart/form-data">
                @csrf
    ...
    <div class="page-content" style="margin-top: -35px;" > 
        ...
        <div class="card-body">
            <h6 class="card-title">Edit Main Thumbnail Image </h6>
                ...
                <form method="post" action="{{ route('technician.update.service.thumbnail') }}" id="myForm" enctype="multipart/form-data">
                    @csrf
...
<div class="page-content" style="margin-top: -35px;" > 
    ...
    <form method="post" action="{{ route('technician.update.service.multiimage') }}" id="myForm" enctype="multipart/form-data">
                @csrf
...
<table class="table table-striped">
    ...
    <a href="{{ route('technician.service.multiimg.delete',$img->id) }}" class="btn btn-danger" id="delete">Delete </a>
            </td>
        </tr>
        @endforeach
            ...
            <form method="post" action="{{ route('technician.store.new.multiimage') }}" id="myForm" enctype="multipart/form-data">
                @csrf
