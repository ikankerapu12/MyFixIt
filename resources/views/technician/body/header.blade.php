...
<div class="input-group-text">
        ...
        <div class="flex-grow-1 me-2">
            ...
            <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" href="#" id="profileDropdown" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <img class="wd-30 ht-30 rounded-circle" src="{{ (!empty($profileData->photo)) ? url('upload/technician_images/'.$profileData->photo) : url('upload/no_image.jpg') }}" alt="profile">
                </a>
                <div class="dropdown-menu p-0" aria-labelledby="profileDropdown">
                    <div class="d-flex flex-column align-items-center border-bottom px-5 py-3">
                        <div class="mb-3">
                            <img class="wd-80 ht-80 rounded-circle" src="{{ (!empty($profileData->photo)) ? url('upload/technician_images/'.$profileData->photo) : url('upload/no_image.jpg') }}" alt="">
                        </div>
    ...
    <li class="dropdown-item py-2">
        <a href="{{ route('technician.profile') }}" class="text-body ms-0">
        <i class="me-2 icon-md" data-feather="user"></i>
        <span>Profile</span>
        </a>
    </li>
    <li class="dropdown-item py-2">
        <a href="{{ route('technician.change.password') }}" class="text-body ms-0">
    ...
    <li class="dropdown-item py-2">
        <a href="{{ route('technician.logout') }}" class="text-body ms-0">
